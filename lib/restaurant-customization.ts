...
export const TEMPLATE_PRESETS: Record<RestaurantTemplateSlug, TemplatePreset> = {
  ...
  adega: {
    ...
    heroTitle: 'Cardápio de bebidas com delivery rápido e gelado.',
    ...
    emptyStateDescription: 'Cadastre cervejas, vinhos e combos para publicar o menu.',
  ...
  padaria: {
    ...
    emptyStateDescription: 'Cadastre pães, bolos e salgados para ativar o cardápio.',
  ...
  acougue: {
    ...
    emptyStateDescription: 'Cadastre cortes, kits e embutidos para publicar o cardápio.',
  ...
  doceria: {
    ...
    emptyStateDescription: 'Cadastre brigadeiros, bolos e trufas para publicar o cardápio.',
