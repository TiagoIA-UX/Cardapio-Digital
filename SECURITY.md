...
Envie um email para **[tiago@tiagoia.dev](mailto:tiago@tiagoia.dev)** com:
...
Esta política cobre o código-fonte do repositório e a instância de produção em [https://zairyx.com.br](https://zairyx.com.br). Não cobre serviços de terceiros (Supabase, Vercel, Mercado Pago, Cloudflare).
