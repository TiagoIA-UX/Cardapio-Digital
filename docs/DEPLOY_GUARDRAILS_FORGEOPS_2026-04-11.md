...
2. Workspace local sujo e divergado da main remota
...
3. Ambiente local de dependencias inconsistente
...
4. Travas de arquivos no Windows (`EPERM`/`Access denied`)
...
2. Preflight minimo de deploy

- `npm ci --no-audit --no-fund`
- `npm run build`
- `npm run lint`

3. Checagem de arquivos criticos importados
...
4. Em Windows (quando houver EPERM)
