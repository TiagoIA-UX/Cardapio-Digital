...
const criticalFiles = [
  ...
  ['lib/supabase/server.ts', 'Cliente server do Supabase'],
  ['lib/mercadopago.ts', 'Integracao Mercado Pago'],
  ['lib/mercadopago-webhook.ts', 'Validacao de assinatura do webhook'],
