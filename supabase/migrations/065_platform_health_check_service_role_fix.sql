-- ============================================================
-- 065 — Corrige falso positivo de policies service_role no monitor
-- A RPC platform_health_check não deve marcar como permissiva uma policy
-- exclusiva da service_role, já que esse acesso é intencional no backend.
-- ============================================================
...
BEGIN
  ...
  WHERE p.schemaname = 'public'
    ...
    AND p.qual = 'true'
    AND NOT (
      COALESCE(array_length(p.roles, 1), 0) = 1
