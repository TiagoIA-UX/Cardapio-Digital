...
const SCENARIOS: Scenario[] = [
  ...
  },
  {
    id: 2,
    icon: Sparkles,
    niche: 'Lanches e burgers com pedidos à noite',
    situation: 'Perde vendas de madrugada',
    text: 'Quando o cliente encontra o link certo, navega rápido e envia o pedido já montado no WhatsApp. Isso reduz abandono, evita conversa picada e ajuda o delivery a capturar pedidos mesmo fora do pico de atendimento da equipe.',
    benefit: 'Menos abandono',
    benefitLabel: 'pedido mais direto no WhatsApp',
  },
  {
    id: 3,
    icon: Store,
    niche: 'Açaí e cremes no Litoral Norte',
